  ...
  UserFeedback({this.name, this.source, this.text});
}

final List<UserFeedback> demo_Feedbacks = [
  UserFeedback(
    name: "Theo Hernández",
    source: "Linkedin",
    text:
        "I have had the pleasure of working with Anas on two flutter projects and what strikes me the most about his work is his ability to write clean and reusable codes with best practices. He is hardworking and makes it so easy to transcribe ideas into beautiful and testable flutter apps. He is a Flutter/Dart gem and has my highest recommendation",
  ),
  UserFeedback(
    name: "Ismail Ben Naser",
    source: "Linkedin",
    text:
        "Anas is great asset for any organization. It's a true pleasure working with him at TakeIn. His flutter skill is amazing as well as his professionalism and being a good team player. Abu's problem solving skill is also one of his great skills.",
  ),
  UserFeedback(
    name: "Sandro Tonali",
    source: "YouTube",
